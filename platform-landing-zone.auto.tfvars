...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "gregt8@gmail.com"

    # Resource group names
    management_resource_group_name            = "rg-management-$${starter_location_01_short}"
    security_resource_group_name              = "rg-security-sentinel-$${starter_location_01_short}"
    ...
    security_log_analytics_workspace_name   = "law-security-sentinel-$${starter_location_01_short}"
